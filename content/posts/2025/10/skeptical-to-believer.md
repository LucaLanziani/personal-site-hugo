...
images:
    - "https://lanziani.com/static/2025/split_brain.jpg"
---
...
### Model Evolution and Agentic Capabilities

*Advances in AI models, particularly the development of "Agentic mode", have enabled previously unfeasible applications.*
...
*I identified specific use cases where LLMs demonstrated undeniable value, prompting further investigation.*
...
*Initial successes fostered increased confidence, leading to broader experimentation and improved skill in leveraging AI.*
...
Drawing from these experiences, I wrote about the [5 mistakes when starting with Agents](https://ainativeteams.com/blog/5-mistakes-with-sdd/) for those just beginning to explore this space.
